...
namespace Strave
{
	...
	public:
		...
		static inline const WindowResolution& GetResolution(void) { return s_GameWindow->m_WindowResolution; }
		static inline const Uint64 GetFramerateCap(void) { return s_GameWindow->m_WindowFramerate.GetFramerateCap(); }
